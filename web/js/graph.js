...
const filters = { priority: 0, amount: 0, nodes: 180 };
...
function panel() {
  ...
  return `<aside class="investigator-left"><header><b>Рабочий срез</b><button id="reset-filters" class="link-button">Сбросить</button></header><div class="filter-fields">
    ...
    <label>Активных вершин <input id="nodes-text" inputmode="numeric" value="180"><input id="nodes-range" type="range" min="20" max="2248" step="10" value="180"></label>
