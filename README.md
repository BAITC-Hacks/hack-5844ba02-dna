...
API также предоставляет ego-сеть, направленный путь, общих контрагентов, циклы, устойчивость, пересчёт пайплайна и детерминированные следующие шаги. Интерактивный Swagger доступен на [http://localhost:8000/docs](http://localhost:8000/docs), ReDoc — на [http://localhost:8000/redoc](http://localhost:8000/redoc), схема OpenAPI — на [http://localhost:8000/openapi.json](http://localhost:8000/openapi.json). Полный контракт: [docs/API.md](docs/API.md).
